...
public class Functions {
	 ...
	 * the value
	 * 
	 *  function signature : combination of return type, function name, and parameters
	 */
	...
	// a function that gets a string, appends "jolly" to it and returns the new String
